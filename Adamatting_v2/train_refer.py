...
def get_logger(fname):
    assert(fname != "")
    logger = logging.getLogger("Demo Matte")
...
def get_args():
    ...
    parser.add_argument('--size_h', default=320, type=int, help="height size of input image")
    parser.add_argument('--size_w', default=320, type=int, help="width size of input image")
    parser.add_argument('--crop_h', default='320,480,640', type=str, help="crop height size of input image")
    parser.add_argument('--crop_w', default='320,480,640', type=str, help="crop width size of input image")
    parser.add_argument('--alphaDir', type=str, default='D:/Samsung-PRISM/Combined_Dataset/Training_set/comp/alpha', help="directory of alpha")
    ...
    parser.add_argument('--stage', type=int, default=0, help="training stage: 0(simple loss), 1, 2, 3")
    parser.add_argument('--testFreq', type=int, default=-1, help="test frequency")
    parser.add_argument('--testImgDir', type=str, default='D:/Samsung-PRISM/Combined_Dataset/Test_set/comp/image', help="test image")
    parser.add_argument('--testTrimapDir', type=str, default='D:/Samsung-PRISM/Combined_Dataset/Test_set/comp/trimap', help="test trimap")
    parser.add_argument('--testAlphaDir', type=str, default='D:/Samsung-PRISM/Combined_Dataset/Test_set/comp/alpha', help="test alpha ground truth")
